...
byte_t ks_shared_memcmp(const void* const b_ptr1, const void* const b_ptr2, const dword_t b_count) {
...
void ks_shared_memU64Tostr(void* const dest, const qword_t src, const byte_t base) {
    static const char digits[] = "0123456789ABCDEF";
    unsigned char* const dst = (unsigned char*)dest; // Interpret as BYTE

    switch (base) {
        case KS_SHARED_MEM_BIN_TAG:
        case KS_SHARED_MEM_OCT_TAG:
        case KS_SHARED_MEM_DEC_TAG:
        case KS_SHARED_MEM_HEX_TAG: {
...
void ks_shared_memcat(void* const dest, const void* const b_ptr1, const void* const b_ptr2) {
...
word_t ks_shared_memlen(const void* const b_ptr, const byte_t unit) {
