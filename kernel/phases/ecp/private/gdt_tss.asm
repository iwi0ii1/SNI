...
ecp_gdt_table_tss: ; TSS (0x38)
    dq 0, 0
ecp_gdt_table_end:

ecp_gdt_ptr:
    dw ecp_gdt_table_end - ecp_gdt_table_start - 1
    dd ecp_gdt_table_start
...
.flush:
    ...
    mov eax, [ecp_gdt_ptr + 2]
    lea ebx, [eax + ecp_gdt_table_tss - ecp_gdt_table_start]
