...
struct hdp_acpi_table_t hdp_acpi_cache_tables_rsdt(const struct hdp_acpi_rsdt_t* const rsdt) {    
    #ifdef DEBUG_FORM
    if (!rsdt) {
...
[[nodiscard]]
ATTR_NO_SSE // Don't use SSE or MMX for this function
struct hdp_acpi_table_t hdp_acpi_cache_tables_xsdt(const struct hdp_acpi_xsdt_t* const xsdt) {
    #ifdef DEBUG_FORM
    if (!xsdt) {
