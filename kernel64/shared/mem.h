 ...
 */
extern byte_t shared_mem_cmp(const void* const b_ptr1, const void* const b_ptr2, const dword_t b_count);
 ...
 */
extern void shared_mem_u64_to_str(void* const dest, const qword_t src, const byte_t base);
 ...
 */
extern word_t shared_mem_len(const void* const b_ptr, const byte_t unit);