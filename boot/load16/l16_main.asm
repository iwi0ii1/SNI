...
%define CFGTB_LOAD_DEST_PKD32_SEGOFF 0x1F00
...
l16_main:
    ...
    mov edx, CFGTB_LOAD_DEST_PKD32_SEGOFF
    call l16_load_from_disk

    ; Load a selection
    mov al, byte [CFG_SIZEB * CFGTB_MAX_CFGS + CFGTB_LOAD_DEST_PKD32_SEGOFF] ; Default selection
    ...
    shl cx, 2 ; CX *= 4
    add ax, cx
    mov cx, CFGTB_LOAD_DEST_PKD32_SEGOFF
