...
l16_main:
    ...
    ; Load 0x100000 - 0x1000FF (config table, 36 bytes each, last 4 bytes for extra infos, cfg before 0xFC)
    xor dx, dx
    mov ax, CFGTB_SECTOR_LOC
    ...
    ; Load a selection
    mov al, byte [CFG_SIZEB * CFGTB_MAX_CFGS + CFGTB_LOAD_DEST] ; Default selection
